...
cryoet-converter encode-annotation "$LOCAL_DATA_STORE_PATH/$RELATIVE_RIBO_ANN_PATH" -o "$LOCAL_DATA_STORE_PATH/TS_026_ribosome" -r 1.348 -c 255 0 0 255 --shard-by-id 1
...
cryoet-converter encode-annotation "$LOCAL_DATA_STORE_PATH/$RELATIVE_FA_ANN_PATH" -o "$LOCAL_DATA_STORE_PATH/TS_026_fatty_acid" -r 1.348 -c 0 0 255 255 --shard-by-id 1
