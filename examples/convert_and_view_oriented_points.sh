...
cryoet-converter encode-annotation "$LOCAL_DATA_STORE_PATH/$RELATIVE_ANN_PATH" -o "$LOCAL_DATA_STORE_PATH/oriented_ribosome" -r 1.348 -c 255 0 0 255 --shard-by-id 1
