...
cryoet-converter create-annotation oriented_ribosome -z "$LOCAL_DATA_STORE_PATH/$RELATIVE_ANN_PATH" -u $REMOTE_DATA_STORE_URL -n "cytosolic ribosome" -o "$LOCAL_DATA_STORE_PATH/oriented_ribosome.json" -s 1.0 --oriented
