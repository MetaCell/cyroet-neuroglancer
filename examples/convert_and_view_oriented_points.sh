...
cryoet-converter create-annotation oriented_ribosome -z "$LOCAL_DATA_STORE_PATH/$RELATIVE_ANN_PATH" -u $REMOTE_DATA_STORE_URL -n "oriented_ribosome" -o "$LOCAL_DATA_STORE_PATH/oriented_ribosome.json" -c "#ff0000 red" -s 0.1 --oriented
