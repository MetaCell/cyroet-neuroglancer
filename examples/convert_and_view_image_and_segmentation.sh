...
cryoet-converter create-segmentation "00004_MT" -u $REMOTE_DATA_STORE_URL -n "00004 MT" -o "$LOCAL_DATA_STORE_PATH/00004_MT.json" -c "#ff0000 red"
...
cryoet-converter create-segmentation "00004_actin" -u $REMOTE_DATA_STORE_URL -n "00004 actin" -o "$LOCAL_DATA_STORE_PATH/00004_actin.json" -c "#0000ff blue"
